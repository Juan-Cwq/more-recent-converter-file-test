...
// Disabled: sppd handler uses .js imports for .ts files which Next.js doesn't resolve
...
// Disabled: batToExe uses Vite-specific ?url imports for .bin files
...
// Disabled: midi handler uses dynamic imports incompatible with Turbopack
...
// Disabled: espeakng imports from directory named "espeakng.js" causing resolution issues
